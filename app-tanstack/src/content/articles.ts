...
`,
  ...
  {
    slug: 'reduction-nombre-parlementaires-france-candidats-2027',
    title: `Réduire le nombre de parlementaires : le débat relancé par Attal, et les positions des ${candidatesCount} candidats à la présidentielle 2027`,
    excerpt:
      "577 députés, 348 sénateurs : Gabriel Attal veut diviser presque par deux le Parlement français. L'idée a déjà échoué deux fois depuis 2018. Pourquoi revient-elle, et où se situent les candidats à la présidentielle 2027 ?",
    date: '2026-08-10',
    tag: 'Analyse',
    content: `
...
<h2>Les positions des ${candidatesCount} candidats à la présidentielle 2027</h2>
<p>La question a été ajoutée <a href="/question-politique/reduction-nombre-parlementaires">au Quizz du Berger</a>, dans le thème <a href="/theme/gouvernance-et-republique">Gouvernance et République</a>. Quatre familles se dégagent, qui ne recoupent pas exactement le clivage gauche-droite.</p>
...
<li><a href="/candidat/patrick-sebastien">Patrick Sébastien</a> — Sa défiance envers la classe politique traditionnelle va dans le sens d'une réduction marquée.</li>
</ul>

<h3>Famille 2 — Réduction significative, comme pièce d'une réforme institutionnelle plus large</h3>
<ul>
<li><a href="/candidat/gabriel-attal">Gabriel Attal</a> (Renaissance) — Propose de passer à 350 députés et 200 sénateurs, avec un référendum annuel, dans ce qu'il présente comme « la plus grande réforme institutionnelle depuis 1958 ».</li>
<li><a href="/candidat/gerald-darmanin">Gérald Darmanin</a> — Proche de la ligne du bloc central, il avait défendu le projet de réduction porté par Emmanuel Macron et Édouard Philippe en 2018.</li>
...
<li><a href="/candidat/laurent-wauquiez">Laurent Wauquiez</a> (LR) — Sa famille politique, très implantée au Sénat, plaide plutôt pour une réforme prudente qui ne fragilise pas la représentation des territoires.</li>
<li><a href="/candidat/bruno-retailleau">Bruno Retailleau</a> (LR) — Ancien sénateur de la Vendée, il devrait privilégier une réduction encadrée plutôt qu'une coupe radicale.</li>
<li><a href="/candidat/xavier-bertrand">Xavier Bertrand</a> — Sa ligne de simplification de l'État peut s'accommoder d'une réduction du nombre d'élus, à condition de préserver l'équilibre territorial.</li>
</ul>
...
<li><a href="/candidat/jerome-guedj">Jérôme Guedj</a> (PS) — Ligne socialiste attachée au pluralisme parlementaire.</li>
<li><a href="/candidat/marine-tondelier">Marine Tondelier</a> (Les Écologistes) — Défend la diversité de représentation, y compris pour les petits partis et les territoires.</li>
<li><a href="/candidat/bernard-cazeneuve">Bernard Cazeneuve</a> — Institutionnaliste, il devrait juger le nombre actuel nécessaire à une représentation équilibrée.</li>
<li><a href="/candidat/raphael-glucksmann">Raphaël Glucksmann</a> (Place Publique) — Sa défense constante des contre-pouvoirs face aux dérives autoritaires suggère une opposition à l'affaiblissement du Parlement.</li>
<li><a href="/candidat/francois-hollande">François Hollande</a> — Ligne institutionnaliste classique, attachée au pluralisme de la représentation.</li>
<li><a href="/candidat/dominique-de-villepin">Dominique de Villepin</a> — Gaulliste attaché à l'équilibre des institutions, il devrait se montrer prudent face à toute réduction drastique.</li>
</ul>

<h2>Réduire le nombre de parlementaires : les arguments</h2>
<table>
<tr><th>Arguments en faveur d'une réduction</th><th>Arguments contre, ou réservés</th></tr>
<tr><td>Un Parlement plus resserré coûterait moins cher : environ 160 millions d'euros d'économie annuelle selon la Fondation IFRAP pour le projet de 2018.</td><td>Des circonscriptions élargies éloigneraient les élus de leurs électeurs, en particulier dans les zones rurales et ultramarines.</td></tr>
<tr><td>Des débats plus resserrés et des votes plus rapides, sur le modèle du Bundestag allemand.</td><td>Le président du Sénat Gérard Larcher y voit une tentative de « contourner le seul contre-pouvoir démocratique qui existe ».</td></tr>
<tr><td>Un député français représente en moyenne moins d'habitants (73 000) qu'un député allemand (environ 100 000).</td><td>Un Parlement plus petit représenterait moins bien le pluralisme politique, notamment les petits partis et les indépendants.</td></tr>
<tr><td>Un mandat plus clair : moins d'élus, chacun mieux identifié par ses électeurs.</td><td>Deux tentatives de réforme, en 2018 et en 2019, ont échoué faute de majorité qualifiée ou de temps parlementaire.</td></tr>
</table>

<h2>Pour aller plus loin</h2>
<ul>
<li><a href="/question-politique/reduction-nombre-parlementaires">Réduire le nombre de parlementaires</a> — la nouvelle question du quiz, avec les réponses détaillées des ${candidatesCount} candidats.</li>
<li><a href="/theme/gouvernance-et-republique">Gouvernance et République</a> — Ve et VIe République, proportionnelle, référendum d'initiative citoyenne.</li>
<li><a href="/question-politique/proportionnelle-elections">Proportionnelle</a> — une réforme souvent proposée en même temps que la réduction du nombre d'élus.</li>
<li><a href="/question-politique/referendum-initiative-citoyenne-ric">RIC</a> — l'autre grand chantier de démocratie directe porté par plusieurs candidats.</li>
</ul>
...
`,
    schema: {
      '@context': 'https://schema.org',
      '@type': 'Article',
      headline: `Réduire le nombre de parlementaires : le débat relancé par Attal, et les positions des ${candidatesCount} candidats à la présidentielle 2027`,
      description:
        "Gabriel Attal propose de réduire le Parlement français à 350 députés et 200 sénateurs. Chronologie du débat depuis 2017, arguments pour et contre, et positions détaillées des candidats à la présidentielle 2027.",
      author: { '@type': 'Person', name: 'Arnaud Ambroselli' },
      datePublished: '2026-08-10',
      about: [
        { '@type': 'Thing', name: 'Réforme institutionnelle' },
        { '@type': 'Thing', name: 'Parlement français' },
        { '@type': 'Thing', name: 'Gabriel Attal' },
        { '@type': 'Thing', name: 'Élection présidentielle française de 2027' },
      ],
    },
  },
