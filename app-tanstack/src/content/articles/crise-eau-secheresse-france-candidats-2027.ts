...
<li><strong>1er juillet 2026</strong> : face à la canicule, la ministre de l'Agriculture Annie Genevard <a href="https://agriculture.gouv.fr/face-a-la-crise-caniculaire-annie-genevard-annonce-un-ensemble-de-mesures-durgence-et-danticipation" target="_blank" rel="noopener noreferrer">annonce un plan de mesures d'urgence</a> (accélération des indemnisations d'assurance récolte, aides à l'équipement des élevages en brumisation et ventilation, soutien au transport de fourrage, fonds hydraulique agricole pour financer des retenues d'eau).</li>
<li><strong>9 juillet 2026</strong> : <a href="https://selectra.info/energie/actualites/marche/secheresse-restrictions-eau-durcies-week-end-juillet-2026" target="_blank" rel="noopener noreferrer">95 des 96 départements métropolitains sont concernés par au moins une mesure de restriction d'eau</a>. Seule la Haute-Corse est épargnée.</li>
<li><strong>16 juillet 2026</strong> : députés et sénateurs réunis en commission mixte paritaire (CMP) <a href="https://www.publicsenat.fr/actualites/parlementaire/projet-de-loi-durgence-agricole-deputes-et-senateurs-parviennent-a-un-accord-en-commission-mixte-paritaire" target="_blank" rel="noopener noreferrer">trouvent un compromis sur la loi d'urgence agricole</a>, adopté par 8 voix (élus centristes, de droite et d'extrême droite) contre 4 (élus de gauche), avec 2 abstentions (macronistes).</li>
...
<li><strong>20 juillet 2026</strong> : <a href="https://www.jamag.fr/actualites/loi-durgence-agricole-accord-parlementaire-trouve-avant-le-vote-final" target="_blank" rel="noopener noreferrer">vote solennel du texte à l'Assemblée nationale</a>.</li>
...
<li>Une <strong>dérogation ministérielle de trois ans maximum</strong>, sur avis de l'Anses, permettant l'usage de deux insecticides néonicotinoïdes interdits en France (flupyradifurone, acétamipride) sur les cultures de betterave, pomme, cerise et noisette, un point hérité du débat sur la <a href="https://fr.wikipedia.org/wiki/Loi_Duplomb">loi Duplomb</a>, promulguée le 12 août 2025 après une <a href="https://www.publicsenat.fr/actualites/politique/loi-duplomb-apres-la-censure-que-contient-le-texte" target="_blank" rel="noopener noreferrer">censure partielle du Conseil constitutionnel</a>.</li>
<li>Le retrait, par rapport à la <a href="https://www.franceinfo.fr/economie/emploi/metiers/agriculture/loi-d-urgence-agricole-le-senat-vote-des-assouplissements-supplementaires-dans-la-gestion-de-l-eau-pour-l-agriculture-irritant-le-gouvernement_8087777.html" target="_blank" rel="noopener noreferrer">version votée au Sénat</a>, d'un principe de « non-régression agricole » qui aurait limité toute nouvelle contrainte sur les prélèvements d'eau agricoles.</li>
</ul>

<h2>Pourquoi ce dossier divise</h2>

<h3>1. Bassines et « guerre de l'eau »</h3>
<p>Depuis les affrontements de <strong>Sainte-Soline</strong> en 2023, <a href="https://www.usinenouvelle.com/article/que-sont-ces-bassines-sources-de-tensions-entre-agriculteurs-et-ecologistes-dans-les-deux-sevres.N2061687" target="_blank" rel="noopener noreferrer">les bassines (ou retenues de substitution) opposent frontalement agriculteurs irrigants et défenseurs de l'environnement</a>. Le 28 mars 2026, la Coordination Rurale a manifesté devant la mégabassine de Sainte-Soline, tandis qu'un collectif « Bassines non merci » s'est constitué en Touraine contre un projet de retenue relancé en Indre-et-Loire. Plusieurs élus locaux, dont le représentant de France Urbaine Ludovic Brossard, ont mis en garde contre le risque d'une véritable « guerre de l'eau » entre usages agricoles, industriels et domestiques.</p>

<h3>2. S'adapter à la chaleur : climatiser ou sobriété ?</h3>
<p>Le 19 juin 2026, en pleine canicule, un échange vif a opposé Marine Le Pen et Jean-Luc Mélenchon sur franceinfo. Marine Le Pen a annoncé vouloir mettre en place, si elle est élue, un <a href="https://www.franceinfo.fr/politique/marine-le-pen/climatiser-partout-ca-veut-dire-augmenter-les-degats-passe-d-armes-entre-jean-luc-melenchon-et-marine-le-pen-en-pleine-vague-de-chaleur_8069294.html" target="_blank" rel="noopener noreferrer">« plan de climatisation massif »</a>, en priorité pour « les hôpitaux, les maisons de retraite, les écoles ». Jean-Luc Mélenchon a rétorqué : « Climatiser partout, ça veut dire augmenter les dégâts », en défendant plutôt son projet d'« écorégions » organisées autour des bassins versants pour « faire entrer l'eau dans le débat ».</p>
...
<ul>
<li><a href="/candidat/marine-le-pen">Marine Le Pen</a> (RN) — A annoncé un « plan de climatisation massif » pour les bâtiments sensibles ; défend aussi les retenues d'eau pour l'agriculture. <a href="https://www.publicsenat.fr/actualites/parlementaire/projet-de-loi-durgence-agricole-deputes-et-senateurs-parviennent-a-un-accord-en-commission-mixte-paritaire" target="_blank" rel="noopener noreferrer">Le RN a voté le compromis de la CMP du 16 juillet</a>.</li>
