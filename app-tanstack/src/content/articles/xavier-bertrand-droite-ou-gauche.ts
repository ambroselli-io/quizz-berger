...
export const article: Article = {
  ...
  tag: 'Analyse',
  content: `
<p>Xavier Bertrand partage 107 réponses sur ${quizzQuestionsCount} avec Gérald Darmanin, soit 91 % de proximité, son score le plus élevé parmi les ${candidatesCount} personnalités du Quizz du Berger. Avec Gabriel Attal, il en partage 90, soit 84 %. Avec Bruno Retailleau, patron des Républicains, le parti dont il vient, il n'en partage que 61, soit 76 %. Sa famille politique de cœur arrive derrière trois responsables du bloc central.</p>
...
<li><a href="/candidat/edouard-philippe">Édouard Philippe</a> (Horizons) — 88 %, 102 réponses identiques.</li>
<li><a href="/candidat/laurent-wauquiez">Laurent Wauquiez</a> (LR) — 88 %, 97 réponses identiques.</li>
<li><a href="/candidat/gabriel-attal">Gabriel Attal</a> (Renaissance) — 84 %, 90 réponses identiques.</li>
<li><a href="/candidat/david-lisnard">David Lisnard</a> (LR) — 79 %, 74 réponses identiques.</li>
<li><a href="/candidat/bruno-retailleau">Bruno Retailleau</a> (LR) — 76 %, 61 réponses identiques.</li>
</ul>
<p>Plus loin viennent <a href="/candidat/eric-zemmour">Éric Zemmour</a> (69 %) et <a href="/candidat/marine-le-pen">Marine Le Pen</a> (65 %). Tout en bas, <a href="/candidat/nathalie-arthaud">Nathalie Arthaud</a> (24 %), <a href="/candidat/juan-branco">Juan Branco</a> (25 %) et <a href="/candidat/jean-luc-melenchon">Jean-Luc Mélenchon</a> (26 %). Les duels détaillés sont ici : <a href="/comparer/raphael-glucksmann-vs-xavier-bertrand">Bertrand contre Glucksmann</a>, <a href="/comparer/juan-branco-vs-xavier-bertrand">Bertrand contre Branco</a>.</p>

<h2>Alors, droite ou gauche ?</h2>
<p>À droite, sans hésitation, sur l'impôt, le travail, l'immigration et la sécurité. Mais une droite pro-européenne et atlantiste, qui ne rouvre pas les lois sociétales. Cette combinaison est exactement celle du bloc central macroniste sur les questions institutionnelles, ce qui explique le podium Darmanin-Philippe-Wauquiez et le score plus faible face à Bruno Retailleau, dont la ligne est plus conservatrice sur la société.</p>
<p>Pour situer précisément : Xavier Bertrand est à 76 % du patron de LR, à 84 % de l'ancien Premier ministre de Macron, et à 65 % de Marine Le Pen. Le classement gauche-droite en un seul axe rend mal ces trois chiffres à la fois.</p>
