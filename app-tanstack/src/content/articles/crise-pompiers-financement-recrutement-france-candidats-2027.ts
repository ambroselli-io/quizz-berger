...
export const article: Article = {
  slug: 'crise-pompiers-financement-recrutement-france-candidats-2027',
  title: `Crise des pompiers : tout comprendre et les positions des ${candidatesCount} candidats à la présidentielle 2027`,
  excerpt:
    "Grève nationale le 13 août, sapeurs-pompiers volontaires reconnus « travailleurs » par le Conseil d'État, financement des Sdis jugé insuffisant : où en est la crise des pompiers, et que proposent les candidats à 2027 ?",
  date: '2026-08-17',
  tag: 'Analyse',
  content: `
...
<ul>
<li><strong>10 octobre 2025</strong> : au congrès national des sapeurs-pompiers au Mans, l'alors ministre de l'Intérieur Bruno Retailleau confirme l'attribution de trimestres de retraite supplémentaires aux volontaires ayant au moins 15 ans de service (un trimestre, puis un de plus tous les 5 ans, dans la limite de trois), pour un coût estimé entre 40 et 45 millions d'euros. Il annonce aussi une revalorisation par décret du taux horaire des indemnités des volontaires, gelé depuis un an, et un nouveau plan d'action pour consolider l'engagement volontaire. Le même jour, sur place, Marine Le Pen réclame la dissolution de l'Assemblée nationale.</li>
<li><strong>9 juillet 2026</strong> : par une décision de section (n° 507853), le Conseil d'État juge que les sapeurs-pompiers volontaires doivent être regardés comme des « travailleurs » au sens de la directive européenne 2003/88/CE sur le temps de travail, tout en validant l'essentiel des dérogations françaises. La décision aboutit huit ans après l'arrêt Matzak de la Cour de justice de l'UE et six ans de procédure interne.</li>
<li><strong>13 août 2026</strong> : neuf organisations syndicales (dont CFDT-SDIS, Sud SDIS et UNSA SDIS), représentant aussi bien les pompiers professionnels que les personnels administratifs et techniques, appellent à la grève dans toute la France. Leurs représentants sont reçus en milieu de journée par Laurent Nuñez place Beauvau, avant un rassemblement syndical à 14 heures.</li>
<li><strong>13-14 août 2026</strong> : les syndicats ressortent « très déçus » de la rencontre, dénoncent l'absence de « réponse concrète » du gouvernement et annoncent une mobilisation renforcée pour septembre.</li>
<li><strong>Début septembre 2026</strong> : le gouvernement doit présenter un projet de loi de modernisation de la sécurité civile, issu du Beauvau de la sécurité civile lancé par Bruno Retailleau lorsqu'il était ministre de l'Intérieur.</li>
</ul>

<h2>Pourquoi le système ne tient plus</h2>

<h3>1. Le volontariat, colonne vertébrale fragilisée par le droit européen</h3>
<p>La France compte environ 197 000 sapeurs-pompiers volontaires, soit près de 78 % des effectifs opérationnels du pays. La plupart exercent une activité professionnelle en parallèle. En reconnaissant leur statut de « travailleurs » au sens du droit de l'Union, le Conseil d'État a validé les dérogations françaises actuelles, mais la décision place désormais les astreintes et permanences des volontaires dans le champ du temps de travail européen, avec des conséquences potentielles sur leur disponibilité et sur les employeurs privés qui les libèrent pour intervenir.</p>

<h3>2. Un financement jugé insuffisant</h3>
<p>Les Sdis sont financés à 60 % par les départements, via une fiscalité locale aux recettes de moins en moins dynamiques. Le Sénat a fait adopter dans le budget 2026 une hausse ciblée de la taxe sur les conventions d'assurance pour mieux les financer, après le rejet d'un amendement similaire en novembre 2025, rejeté notamment par les voix du Rassemblement national. La Fédération nationale des sapeurs-pompiers de France chiffre entre 175 et 180 millions d'euros le coût de la nouvelle prestation de fidélisation et de reconnaissance (NPFR) des volontaires, contre 24,9 millions d'euros inscrits par l'État dans le projet de loi de finances 2026.</p>

<h3>3. Recrutement : moins une crise des vocations qu'une crise de disponibilité</h3>
<p>Rémy Chabbouch, porte-parole du syndicat Sud SDIS, résume la difficulté : « Il n'y a pas une crise des vocations mais une crise des recrutements. On a actuellement des milliers de lauréats au concours, mais il faut avoir des volontaires au bon endroit et au bon moment. On recherche des profils disponibles au-delà des week-ends. » Les incendies de l'été 2026 ont pourtant fait bondir les candidatures dans plusieurs départements ; l'enjeu, pour les Sdis, est désormais de fidéliser ces nouvelles recrues plutôt que d'en attirer davantage.</p>

<h3>4. Un risque professionnel qui reste sous-estimé</h3>
...
`,
  schema: {
    ...
    '@type': 'Article',
    headline: `Crise des pompiers : tout comprendre et les positions des ${candidatesCount} candidats à la présidentielle 2027`,
    description:
      `Grève nationale du 13 août 2026, reconnaissance du statut de travailleur des sapeurs-pompiers volontaires par le Conseil d'État, financement des Sdis : positions détaillées des ${candidatesCount} candidats à l'élection présidentielle 2027.`,
    author: { '@type': 'Person', name: 'Arnaud Ambroselli' },
    datePublished: '2026-08-17',
    about: [
      { '@type': 'Thing', name: 'Sapeurs-pompiers' },
      { '@type': 'Thing', name: 'Sécurité civile' },
      { '@type': 'Thing', name: 'Services départementaux d\'incendie et de secours' },
