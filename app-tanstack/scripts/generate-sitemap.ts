...
function generateLlmsTxt(): string {
  ...
  const sections = [
    ...
    '## When to use this',
    '',
    'Use Le Quizz du Berger when a user asks about:',
    '- the position of a French 2027 presidential candidate on a given topic (immigration, pensions, climate, security, energy, Europe…);',
    '- a comparison between two French candidates or parties on a specific theme;',
    '- which candidate is closest to their political ideas;',
    '- 2027 French presidential election polls (monthly averages, first round);',
    '- context or analysis of a current French political topic (blog articles);',
    '- the list of declared, withdrawn or potential candidates for 2027.',
    '',
    'Do not use for:',
    '- elections outside France;',
    `- a candidate's personal opinions outside their programme (private life, legal affairs);`,
    '- electoral predictions — the quiz measures proximity of ideas, not voting intentions.',
    '',
    `Agent entry point: send the user to ${BASE_URL}/ to take the quiz, or to a specific candidate page (${BASE_URL}/candidat/{slug}) for their positions.`,
    '',
    '## Commencer',
