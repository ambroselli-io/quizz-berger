...
export default function SujetsIndex() {
  return (
    <>
      <title>Tous les sujets de la présidentielle 2027 | Le Quizz du Berger</title>
      <meta
        name="description"
        content={`Explorez les ${themeSlugMap.length} thèmes et les sujets clés de l'élection présidentielle 2027 : positions des candidats, programmes, comparatifs.`}
      />
