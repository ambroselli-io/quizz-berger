# Google Play — fiche du Store (à coller à la main)

> EAS Metadata ne gère QUE l'App Store (Apple). Pour Google Play, copier-coller les champs ci-dessous dans la Play Console (Présence sur le Store → Fiche principale du Store).

## URL de la politique de confidentialité (champ « Confidentialité » de la Play Console)
https://www.quizz-du-berger.com/confidentialite
...
• Neutralité : les questions ont été rédigées par des étudiants de droite ET de gauche, pour éviter tout biais.
• Transparence : le projet est open-source.
• Gratuit, sans pub intrusive, et conçu pour vous faire réfléchir — pas pour vous dire quoi penser.

Plus de 200 000 quizz déjà réalisés et près de 10 millions de réponses données.
